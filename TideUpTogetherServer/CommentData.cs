...
namespace TideUpTogetherServer {
    ...
    public class CommentData {
        ...
        static string MakeParagraph(int baseIndex, WordType wordType, int wordIndex) {
            ...
            var bases = MessageTable.BaseTemplates;
            var words = MessageTable.Words;
            ...
            return bases[baseIndex].Replace("~", words[wordTypeIndex][wordIndex]);
        }
        
        internal string ToMessageString() {
            
            if (!MessageTable.IsLoaded)
                return $"(type={Type}, fpara={FirstBaseParagraph}, fword={FirstWordType}:{FirstWordId})";
            ...
            var adverbs = MessageTable.Adverbs;
